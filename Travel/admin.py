...
from .models import Image,home,visions,record,mztj,link,xiangce,feature,YDt,fea_index1,fea_history,fea_place,m_hotel,m_visitors,ydtravel
...
class ydtravelInfoAdmin(admin.ModelAdmin):
	list_display = ("name",)
...
admin.site.register(ydtravel,ydtravelInfoAdmin)
